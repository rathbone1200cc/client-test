...
exports.run = function(options, callback){
  ...
  q.drain = function(){
    ...
    var stats = registration.getStats()
    stats.totalRun = testsStarted
    console.log("Finished " + stats.totalRun + " tests. Failed " + stats.assertFails + " asserts and " + stats.compareFails + " compares.")
    callback(stats)
  }
